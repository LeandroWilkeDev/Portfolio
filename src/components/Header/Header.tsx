...
export default function Header() {
  ...
  return (
    <header data-aos-duration="1000" data-aos="fade-down" className="w-full max-w-full bg-[var(--color-react-card)]/80 backdrop-blur-lg fixed top-0 left-0 z-50 shadow-md border-b border-[var(--color-react-border)] box-border">
      ...
      {/* Menu lateral mobile */}
      {menuOpen && (
        <div className="sm:hidden absolute top-16 left-0 w-full bg-[var(--color-react-card)]/95 shadow-lg flex flex-col items-center gap-6 py-8 animate-fade-in z-50">
          <a href="#about" className="text-lg font-bold bg-gradient-to-r from-[var(--color-react-blue)] via-[var(--color-react-cyan)] to-[var(--color-react-purple)] bg-clip-text text-transparent drop-shadow-lg tracking-tight transition" onClick={() => setMenuOpen(false)}>Sobre mim</a>
          <a href="#skills" className="text-lg font-bold bg-gradient-to-r from-[var(--color-react-blue)] via-[var(--color-react-cyan)] to-[var(--color-react-purple)] bg-clip-text text-transparent drop-shadow-lg tracking-tight transition" onClick={() => setMenuOpen(false)}>Skills</a>
          <a href="#projects" className="text-lg font-bold bg-gradient-to-r from-[var(--color-react-blue)] via-[var(--color-react-cyan)] to-[var(--color-react-purple)] bg-clip-text text-transparent drop-shadow-lg tracking-tight transition" onClick={() => setMenuOpen(false)}>Projetos</a>
      ...
      <div className="hidden sm:flex flex-row items-center justify-between w-full px-20 py-5">
        ...
        <nav className="flex gap-8 mb-0">
          <a href="#about" className="bg-gradient-to-r from-[var(--color-react-blue)] via-[var(--color-react-cyan)] to-[var(--color-react-purple)] bg-clip-text text-transparent drop-shadow-lg tracking-tight transition nav-underline">Sobre mim</a>
          <a href="#skills" className="bg-gradient-to-r from-[var(--color-react-blue)] via-[var(--color-react-cyan)] to-[var(--color-react-purple)] bg-clip-text text-transparent drop-shadow-lg tracking-tight transition nav-underline">Skills</a>
          <a href="#projects" className="bg-gradient-to-r from-[var(--color-react-blue)] via-[var(--color-react-cyan)] to-[var(--color-react-purple)] bg-clip-text text-transparent drop-shadow-lg tracking-tight transition nav-underline">Projetos</a>
        </nav>
